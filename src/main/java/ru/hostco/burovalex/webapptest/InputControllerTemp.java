...
public class InputControllerTemp extends SelectorComposer<Component> {
    ...
    //services
    AuthenticationService authService = new Authentication();
    UserInfoService userInfoService = new UserInfo();
